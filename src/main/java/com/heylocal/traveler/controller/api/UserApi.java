...
public interface UserApi {
    ...
    @Operation(summary = "사용자가 남긴 매니저 평가 리스트 조회", description = "로그인한 사용자가 남긴 매니저 평가 리스트 조회")
    ...
    @Operation(summary = "사용자 푸쉬 알림 리스트 조회", description = "로그인한 사용자가 받은 모든 푸쉬 알림 리스트 조회")
    @GetMapping("/notifications")
    ResponseEntity<Void> userNotificationsGet();


    @Operation(summary = "사용자의 결제 내역과 남은 포인트 조회", description = "로그인한 사용자의 결제 내역과 남은 포인트 조회")
    @GetMapping("/payment")
    ResponseEntity<Void> userPaymentGet(
        @Parameter(in = ParameterIn.QUERY, description = "조회할 페이지 번호", required = true) @RequestParam int page);


    @Operation(summary = "사용자 프로필 사진, 닉네임 조회", description = "로그인한 사용자의 프로필 사진과 닉네임 조회")
    @GetMapping("/profile")
    ResponseEntity<Void> userProfileGet();


    @Operation(summary = "사용자 프로필 사진, 닉네임 수정", description = "로그인한 사용자 프로필 사진, 닉네임 수정")
    ...
    @Operation(summary = "사용자가 남긴 방문 리뷰 리스트 조회", description = "로그인한 사용자가 남긴 방문 리뷰 리스트 조회")
