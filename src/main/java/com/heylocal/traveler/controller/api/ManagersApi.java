...
public interface ManagersApi {
    ...
    @Operation(summary = "해당 매니저의 꿀팁노트 리스트 조회", description = "", tags={ "manager" })
    ...
    @Operation(summary = "해당 매니저의 꿀팁노트 상세 조회", description = "", tags={ "manager" })
    ...
    @Operation(summary = "해당 매니저의 프로필 조회", description = "", tags={ "manager" })
    ...
    @Operation(summary = "해당 매니저에게 매니저 리뷰 등록", description = "", tags={ "manager" })
