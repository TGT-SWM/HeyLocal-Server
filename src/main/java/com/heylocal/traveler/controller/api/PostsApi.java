...
public interface PostsApi {
    ...
    @Operation(summary = "테마 관련 포스트 리스트 조회", description = "", tags = {"Posts"})
    @GetMapping("/posts")
    ...
    @Operation(summary = "포스트 상세 조회", description = "", tags = {"Posts"})
    @GetMapping("/{postId}")
    ...
    @Operation(summary = "해당 포스트에 관련된 방문 리뷰 리스트 조회", description = "", tags = {"Posts"})
    ...
    @Operation(summary = "해당 포스트에 방문 리뷰 등록", description = "", tags = {"Posts"})
    ...
    @Operation(summary = "해당 포스트의 자신의 방문 리뷰 삭제", description = "", tags = {"Posts"})
